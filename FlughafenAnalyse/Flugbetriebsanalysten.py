...
airports = pd.read_csv('Dataset/airports.csv')  # Stellen Sie sicher, dass diese Datei die Namen der Flughäfen enthält

# Stellen Sie sicher, dass alle Verspätungsspalten und DEPARTURE_DELAY korrekt formatiert sind
...
# Ermitteln Sie die Top 5 Flughäfen mit den meisten Verspätungen
...
# Erstellen Sie für jeden der Top 5 Flughäfen ein Kuchendiagramm
